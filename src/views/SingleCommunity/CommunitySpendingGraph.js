...
// chart data
import chartData from '../SingleCommunity/chart-data/communitySpendingChartData';
...
const CommunitySpendingGraph = ({ isLoading }) => {
...
export default CommunitySpendingGraph;
